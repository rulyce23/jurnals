...
//
// jc: a QR code was readed.. And now ?
//
...
function read(a)
{
    ...
    // we do a secret GET on the vote URL
    d3.json('/vote/123/1', function (xdata){
     // alert(a);
    });
...
<div id="main">
<div id="header">
<div style="position:relative;top:+80px;left:80px;">
...
<div id="mainbody">
<table class="tbsbody" border="0" width="100%">
<tr>
<td valign="top" align="center" width="90%">
<table class="tbsbody" border="0">
<tr>
<td><img class="selector" id="webcamimg" onclick="setwebcam()" align="center" /></td>
<td><img class="selector" id="qrimg" onclick="setimg()" align="center"/></td></tr>
